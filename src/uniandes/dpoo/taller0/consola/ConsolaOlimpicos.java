...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar nacionalidad de un atleta por nombre");
	...
	/**
	 * Opción para consultar la nacionalidad de un atleta dado su nombre
	 */
	private void ejecutarNacionalidadAtleta() {
		System.out.println("\n" + "Nacionalidad de atleta" + "\n");
		
		String nombreAtleta = input("Ingrese el nombre del atleta");
		String nombrePais = calculadora.consultarNacionalidadAtleta(nombreAtleta);
		System.out.println("La nacionalidad de " + nombreAtleta + " es " + nombrePais);
	}
